...
class ReadRetrieveReadApproach(Approach):
    template_prefix = (
        ...
        "Beantworten Sie die Frage ausschließlich mit den in den untenstehenden Informationsquellen bereitgestellten Daten. "
        "Geben Sie tabellarische Informationen als HTML-Tabelle zurück. Verwenden Sie kein Markdown-Format. "
        "Jede Quelle hat einen Namen, gefolgt von einem Doppelpunkt und den eigentlichen Daten, zitieren Sie den Quellennamen für jedes Datenstück, das Sie in der Antwort verwenden. "
        'Zum Beispiel, wenn die Frage lautet "Welche Farbe hat der Himmel?" und eine der Informationsquellen sagt "info123: der Himmel ist blau, wenn es nicht bewölkt ist", dann antworten Sie mit "Der Himmel ist blau [info123]" '
        'Es ist wichtig, das Format streng einzuhalten, wobei der Name der Quelle am Ende des Satzes in eckigen Klammern steht und nur bis zum Präfix vor dem Doppelpunkt (":"). '
        'Wenn es mehrere Quellen gibt, zitieren Sie jede in ihren eigenen eckigen Klammern. Zum Beispiel, verwenden Sie "[info343][ref-76]" und nicht "[info343,ref-76]". '
        "Zitieren Sie niemals Tool-Namen als Quellen."
        "Wenn Sie die Frage nicht mit den untenstehenden Quellen beantworten können, sagen Sie, dass Sie es nicht wissen. "
        "\n\nSie haben Zugang zu folgenden Tools:"
    )
    ...
    CognitiveSearchToolDescription = "nützlich für die Suche nach Informationen zu Mitarbeiterleistungen von Microsoft, wie zum Beispiel Gesundheitspläne, Rentenpläne usw."
